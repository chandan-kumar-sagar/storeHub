...
// Import the same nice background image for consistency
      ...
      >
        ...
        <form onSubmit={handleRegister} className="space-y-5">
          ...
          <p className="text-xs text-gray-500">
            By signing up, you agree to our <span className="text-green-600 cursor-pointer hover:underline">Terms of Service</span> and <span className="text-green-600 cursor-pointer hover:underline">Privacy Policy</span>.
          </p>
